...
#ifndef STACK_WAITFREE_NODE_H
#define STACK_WAITFREE_NODE_H
...
bool pop_fast(wf_stack_t* s, int64_t tid, node_t** ret_n);
void pop_slow(wf_stack_t* s, int64_t tid, node_t** ret_n);

void try_clean_up(wf_stack_t* s, int64_t tid);
void clean(node_t* left, node_t* right);

#endif /* STACK_WAITFREE_NODE_H */
